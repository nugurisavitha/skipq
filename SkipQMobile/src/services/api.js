...
const API_BASE_URL = 'https://skipq-beta.up.railway.app/api';
...
// Response interceptor: unwrap backend { success, data } envelope & handle 401
api.interceptors.response.use(
  (response) => {
    // Backend wraps responses as { success: true, data: { ... } }
    // Unwrap so callers get the inner data directly on response.data
